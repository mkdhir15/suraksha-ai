  ...
  return (
    <div className={`inline-flex items-center gap-3 select-none ${className}`}>
      ...
      <svg
        ...
        className={variant === 'icon' ? 'w-8 h-10' : 'w-10 h-12'}
      ...
      >
        ...
        {/* Stylized Angular 'S' Path */}
        <path
          d="M68 32 H40 L34 48 H58 L52 64 H68 L58 84 L32 60 H48 L68 32 Z"
          fill="url(#sGrad)"
        />

        {/* AI Circuit Node Trail (3 connected dots) */}
        ...
        {/* Community/Family 3 Human Figures Silhouette Base */}
